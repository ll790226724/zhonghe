module.exports = [
  ...
  },
  {
    ...
    props: {
      ...
      $url: "`/v1/components/04b74ddd-39de-493f-84ab-9d87fcf23fee/data?year=${generateYear}&job=${craneStates.currentJob}`",
      method: 'get',
      $data: "[['']]",
      $style: {
        width: '400px',
  ...
  },
  {
    ...
    props: {
      ...
      $url: "`/v1/components/05b74ddd-39de-493f-84ab-9d87fcf23fee/data?year=${generateYear}&job=${craneStates.currentJob}`",
      method: 'get',
      $data: "[['']]",
      $style: {
        width: '400px',
