<template>
  <div class="high_talents">
    ...
    <data-loader v-slot="{ results: results }" :url="`/v1/components/00204ddd-39de-493f-84ab-9d87fcf23fee/data?area=${craneStates.currentDepartment ? craneStates.currentDepartment : ''}`" method="get" :data="[[0, '暂无数据']]" :style="{width: '460px', height: '218px', position: 'absolute', top: '280px', left: '559px'}">
