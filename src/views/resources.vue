<template>
  <div class="resources">
    ...
    <data-loader ref="talent-industry-index" v-slot="{ results: results }" :url="`/v1/components/14b74ddd-39de-493f-84ab-9d87fcf23fee/data?city=${craneStates.department.label}市&type='人才产业指数'`" method="get" :data="[[0]]" :style="{position: 'absolute', top: '440px', left: '290px'}">
