<template>
  <div class="resources">
    ...
    <data-loader ref="part-production-value" v-slot="{ results: results }" :url="`/v1/components/12b74ddd-39de-493f-84ab-9d87fcf23fee/data?city=${craneStates.department.label}`" method="get" :data="[[0]]" :style="{position: 'absolute', top: '56px', left: '130px'}">
      <digital-roll ref="deal-number-total" v-if="results" titlePosition="left" :content="{title: '地区生产总值', prefix: '￥', suffix: '万元', digital: results[0][0] || 0}" :options="{separator: ','}" :titleStyle="{color: '#367391', fontSize: '16px', fontWeight: '400'}" :prefixStyle="{color: '#367391', fontSize: '16px', fontWeight: '400'}" :suffixStyle="{color: '#367391', fontSize: '16px', fontWeight: '400'}" :digitalStyle="{fontSize: '32px', color: '#6ad6ff', fontWeight: '400', fontFamily: 'Oswald-Regular', format: '11', letterSpacing: '2.4px'}" />
    </data-loader>
    ...
    <data-loader ref="talent-age-index" v-slot="{ results: results }" :url="`/v1/components/14b74ddd-39de-493f-84ab-9d87fcf23fee/data?city=${craneStates.department.label}市&type='人才年龄指数'`" method="get" :data="[[0]]" :style="{position: 'absolute', top: '440px', left: '90px'}">
    ...
    <data-loader ref="talent-education-index" v-slot="{ results: results }" :url="`/v1/components/14b74ddd-39de-493f-84ab-9d87fcf23fee/data?city=${craneStates.department.label}市&type='人才学历指数'`" method="get" :data="[[0]]" :style="{position: 'absolute', top: '332px', left: '90px'}">
    ...
    <data-loader ref="talent-industry-index" v-slot="{ results: results }" :url="`/v1/components/14b74ddd-39de-493f-84ab-9d87fcf23fee/data?city=${craneStates.department.label}市&type='人才行业指数'`" method="get" :data="[[0]]" :style="{position: 'absolute', top: '440px', left: '290px'}">
    ...
    <data-loader ref="talent-quality-index" v-slot="{ results: results }" :url="`/v1/components/14b74ddd-39de-493f-84ab-9d87fcf23fee/data?city=${craneStates.department.label}市&type='人才素质指数'`" method="get" :data="[[0]]" :style="{position: 'absolute', top: '548px', left: '90px'}">
    ...
    <data-loader ref="talent-rank-index" v-slot="{ results: results }" :url="`/v1/components/14b74ddd-39de-493f-84ab-9d87fcf23fee/data?city=${craneStates.department.label}市&type='人才职称指数'`" method="get" :data="[[0]]" :style="{position: 'absolute', top: '332px', left: '290px'}">
    ...
    <data-loader ref="talent-synthesis-index" v-slot="{ results: results }" :url="`/v1/components/14b74ddd-39de-493f-84ab-9d87fcf23fee/data?city=${craneStates.department.label}市&type='人才综合指数'`" method="get" :data="[[0]]" :style="{position: 'absolute', top: '548px', left: '290px'}">
...
import fuzhou from '../../public/hxcr/fuzhou.json'
...
.resources {
  ...
  width: 100%;
  height: 100%;
  background-image: url('../../public/hxcr/images/Bg.png');
}
